...
export const NotFoundSearchResult: FC<{ keyword: string }> = ({ keyword }) => {
    // Templates
    return (
        <div className="max-w-screen-2xl h-[500px] flex justify-center items-center">
            <div className="flex flex-col justify-center items-center text-white text-center">
                <h1 className="my-8 text-2xl md:text-4xl font-bold tracking-wide">No Results Found For : {keyword}</h1>
